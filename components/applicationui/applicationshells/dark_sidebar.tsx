...
const navigation = [
  ...
  { name: 'Products', href: '/admin/products', icon: DocumentDuplicateIcon, current: true },
...
const teams = [
  { id: 1, name: 'Add new product', href: '#', initial: 'P', current: false },
  { id: 2, name: 'add new order', href: '#', initial: 'O', current: false },
